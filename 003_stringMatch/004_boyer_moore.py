...
# from pyxDamerauLevenshtein import damerau_levenshtein_distance, boyer_moore
# string = "Hello, World!"
# substring = "World"
# index = boyer_moore(string, substring)
# print(index)

# pyxDamerauLevenshtein is not a python library. Boyer-Moore algorithm can be implemented manually in python, The basic idea behind the algorithm is to preprocess the substring to create a "bad character" rule and a "good suffix" rule, which can be used to quickly skip over parts of the larger string that are unlikely to contain the substring.
